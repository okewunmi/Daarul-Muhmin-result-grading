...
export const studentsManager = {
  ...
  //       config.DATABASE_ID,
  //       config.STUDENTS_COLLECTION_ID,
  //       [Query.equal('registrationNumber', studentData.registrationNumber)]
  //     );
  ...
  //         // academicSessionId: studentData.academicSessionId,
  //         // dateOfBirth: studentData.dateOfBirth || '',
  //         gender: studentData.gender || '',
  //         // parentName: studentData.parentName || '',
  //         // parentNameArabic: studentData.parentNameArabic || '',
  //         // parentPhone: studentData.parentPhone || '',
  //         // parentEmail: studentData.parentEmail || '',
  //         // address: studentData.address || '',
  //         // addressArabic: studentData.addressArabic || '',
  ...
  //   }
  // },
// Replace the create function in studentsManager
